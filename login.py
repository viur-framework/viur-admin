...
class Login(QtWidgets.QMainWindow):
    ...
    def onBtnLoginReleased(self):
        ...
        if (cb.currentIndex() == -1):
            reply = QtGui.QMessageBox.question(self, QtCore.QCoreApplication.translate("Login", "Save this account"),
                                               QtCore.QCoreApplication.translate("Login",
                                                                                 "Save this account permanently?"),
                                               QtGui.QMessageBox.Yes | QtGui.QMessageBox.No, QtGui.QMessageBox.No)
            if reply == QtGui.QMessageBox.Yes:
                pw = password
                accname, okaypressed = QtGui.QInputDialog.getText(self, QtCore.QCoreApplication.translate("Login",
                                                                                                          "Save this "
                                                                                                          "account"),
                                                                  QtCore.QCoreApplication.translate("Login",
                                                                                                    "Enter a name for "
