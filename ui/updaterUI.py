...
#
# Created: Tue Jun 11 11:39:45 2013
...
class Ui_Updater(object):
    ...
    def retranslateUi(self, Updater):
        Updater.setWindowTitle(_translate("Updater", "ViUR Admin Updater", None))
        self.btnCheck.setText(_translate("Updater", "Check for Updates", None))
        self.btnUpdate.setText(_translate("Updater", "Update now", None))
        self.btnExit.setText(_translate("Updater", "Exit", None))
